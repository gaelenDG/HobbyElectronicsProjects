...
//   static int nfcFails = 0;
//   unsigned long now = millis();
//   bool DFPlayer_connected = player.available();
...
//       // Confirm multiple misses before flagging it lost
      
//       if (++dfFails >= 3) {
//         dfplayerOK = false;
//         dfFails = 0;
//         Serial.println("Lost DFPlayer connection - attempting reconnection");
//         dfplayerOK = false;
...
//     } else {
//       dfFails = 0;
//       Serial.print("DFPlayer reconnected!");
//     }
//   }
...
//     if (!nfcOK) {
//       nfcOK = true;
//       Serial.printf("PN532 reconnected (fw 0x%08X)\n", versiondata);
//     }
//   } else {
//     // Confirm multiple misses before it fails
...
//         nfcOK = false;
//         Serial.println("Lost PN532 connection - attempting reconnection");
